  ...
  if (topic == "arvidud") {
    ...
    for (int i = 0; i < length; i++) {
      ...
      if (payload == "On") {
        ...
        delay(10);
        client.publish("Status", "Viggo er en bitch og pæren er tændt");
      }
      else if (payload == "Off") {
        // Definerer funktion som bruges til at styre temperaturmåling
        digitalWrite(ledPin, LOW);
        delay(10);
        client.publish("Status", "Viggo er STADIG en bitch, men nu er pæren slukket");
      }
      else {
